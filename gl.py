...
#
        ...
        self.tiempo = 0
        self.position_inicio = glm.vec3(0, 0, 0)
        self.valor = 0
        ...
        self.view_matrix = self.getViewMatrix()
    ...
    def rotacion_derecha(self,rotar, foco):
        inicio = self.position_inicio
        self.angulo = self.angulo + rotar
        self.camPosition.z = glm.cos(glm.radians(self.angulo)) * self.radio
        self.camPosition.x = glm.sin(glm.radians(self.angulo)) * self.radio
        self.view_matrix = glm.lookAt(inicio - self.camPosition, foco, glm.vec3(0.0,1.0,0.0))
